...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"R\n" +
	"\bRegistry\x12*\n" +
	"\x06consul\x18\x01 \x01(\v2\x12.kratos.api.ConsulR\x06consul\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpointB\x1dZ\x1breview-o/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3, // 1: kratos.api.Bootstrap.registry:type_name -> kratos.api.Registry
	4, // 2: kratos.api.Server.http:type_name -> kratos.api.Server.HTTP
	5, // 3: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	2, // 4: kratos.api.Registry.consul:type_name -> kratos.api.Consul
